...
@SuppressWarnings({"JavaPrintToLogpoint", "ExtractMethodRecommender", "unused"})
public class Main {
        ...
        if (ansyM1.equalsIgnoreCase("y")) {
            ...
            q.offer(() -> {
                ...
                Function<TreeNode, List<List<Integer>>> levelOrderBottom = (root) -> {
                    ...
                    List<List<Integer>> finalDq = new LinkedList<>();
                ...
                Function<LeetNode, LeetNode> connect = (root) -> {
                    ...
                    while (!qu.isEmpty()) {
                        ...
                        for (var i = 0; i < temp.size()-1; i++) {
                            ...
                            currentLeetNode.next = temp.get(i+1);
                        }
                    }
