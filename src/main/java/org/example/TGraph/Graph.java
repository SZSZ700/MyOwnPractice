...
public class Graph<T> {
    ...
    public ArrayList<Edge<T>> getAllEdges() {
        ...
        BiFunction<ArrayList<Edge<T>>, Edge<T>, Boolean> contains = getContains();
    ...
    private static <T> @NotNull BiFunction<ArrayList<Edge<T>>, Edge<T>, Boolean> getContains() {
